...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mAlifDK
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801726742018
\x1b[93;1m Group       \x1b[92;1m=>      \x1b[93;1mAlifDK
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	print("""%s \33[1;33m[0] Join AlifDK"""%(h))
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
...
def setting():
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
	print("""%s \33[1;33m[01] Forward Cracking """%(h))
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [ AY4N ] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [AY4N-CP] %s|%s        '%(b,idf,pw))
